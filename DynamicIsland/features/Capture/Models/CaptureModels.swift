...
enum CaptureError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        ...
        case .destinationAccessLost: String(localized: "Work Tempo can no longer access the selected save folder.")
        case .encodingFailed: String(localized: "The captured image could not be encoded.")
        case .recordingAlreadyActive: String(localized: "Work Tempo is already recording.")
        case .recordingNotActive: String(localized: "Work Tempo is not recording.")
